...
const GridProductCard = ({ item }: GridProductCardProps) => {
    ...
    <Card sx={{ position: "relative" }}>
      ...
      >
        ...
        {checked && (
          <FlexBox gap={1}>
            <StyledIconButton>
              <Edit sx={{ fontSize: 12, color: "text.disabled" }} />
            </StyledIconButton>
            <StyledIconButton>
              <Delete sx={{ fontSize: 12, color: "text.disabled" }} />
            </StyledIconButton>
          </FlexBox>
        )}
      </FlexBetween>
      ...
      <CardContent
        sx={{ textAlign: "center", "&:last-child": { paddingBottom: 2 } }}
      >
