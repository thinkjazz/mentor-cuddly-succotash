...
const StyledStatus = styled(Span)<{ error?: boolean }>(({ theme, error }) => ({
  padding: "3px 8px",
  borderRadius: "4px",
...
const ApiKeys: FC = () => {
  const tableHeadColor = (theme: Theme) =>
    ...
    <Card>
      ...
      <Scrollbar autoHide={false}>
        <Table sx={{ minWidth: 800 }}>
          <TableHead sx={{ backgroundColor: (theme) => tableHeadColor(theme) }}>
            <TableRow>
                ...
                <StyledBodyTableCell>
                  <FlexBox alignItems="center">
                    ...
                    <CopyToClipboard text={item.key} onCopy={() => true}>
                      <IconButton>
                        <Copy sx={{ fontSize: 17, color: "text.disabled" }} />
                      </IconButton>
                    </CopyToClipboard>
                  </FlexBox>
                </StyledBodyTableCell>
