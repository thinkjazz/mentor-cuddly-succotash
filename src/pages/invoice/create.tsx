...
const CreateInvoice: FC = () => {
  const [items, setItems] = useState([
    { id: 1, name: "Name 1", qty: 2, price: 25 },
    { id: 2, name: "Name 2", qty: 2, price: 25 },
  ]);

  const handleAddItem = () => {
    setItems([...items, { id: Date.now(), name: "Name 3", qty: 1, price: 20 }]);
  };
        ...
        <Grid item md={4} xs={12}>
          <Card sx={{ padding: 2 }}>
            ...
            <Button
              fullWidth
              variant="contained"
              startIcon={<Send sx={{ fontSize: "15px !important" }} />}
            >
              Send Invoice
            </Button>
          </Card>
